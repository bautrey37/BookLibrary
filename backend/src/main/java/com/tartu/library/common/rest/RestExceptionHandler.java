...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleConstraintViolation(
    ...
    apiError.addValidationConstraintViolationErrors(ex.getConstraintViolations());
    return buildResponseEntity(apiError);
  }
  ...
  protected ResponseEntity<Object> handleValidationError(ValidationErrorException ex) {
    ApiError apiError = new ApiError(BAD_REQUEST);
    apiError.setMessage("Validation Error");

    for (BindingResult BR : ex.getBindingResults()) {
      apiError.addValidationFieldErrors(BR.getFieldErrors());
